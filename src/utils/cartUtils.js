...
export function addToCart(product, quantity = 1, finishOption = null) {
  ...
  if (existingIndex > -1) {
    ...
    const newItem = {
      ...
      name: displayName,
      arabicName: product.arabicName ? (finishOption ? `${product.arabicName} (${finishOption})` : product.arabicName) : undefined,
      category: product.category || 'Furniture',
      arabicCategory: product.arabicCategory || undefined,
